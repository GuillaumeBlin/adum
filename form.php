...
$parsing_types = array("doctors_of_the_year" => "Docteur.e.s d'une année", "phd_proposal" => "Propositions de sujets de thèses", "annu" => "Annuaire des doctorant.e.s d'une année", "phd_defense_by_ed" => "Soutenances à venir", "members_annu" => "Annuaire des encadrant.e.s", "training_by_ed" => "Formations à venir", "cotutelle_by_ed" => "Cotutelle à venir", "");
