...
class Controller extends BlockController
{
    ...
    private function display_annu($defense)
    {
        ...
        echo "<li>";
        if (strcmp($this->langage, "FR") == 0) {
            echo  $this->totitle($defense["prenom"]) . ' ' . $defense["nom"] ;
            echo  ' (' . $year . ' année) - ';
    ...
    */
    ...
    private function load_phd_defense_by_ed()
    {
        ...
        $students = array_filter($students, function ($student) {
            return ((strtotime("today") <= strtotime($student["these_date_soutenance"])) && (strcmp($student["these_visibilite"],"huis clos") != 0));
