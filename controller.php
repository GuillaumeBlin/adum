        ...
        function get_display_defense_to_come($defense,$lang)
{
    ...
    if (strcmp($lang, "FR") == 0) {
        ...
        $res.="</ul></p>";
        $res.='<p><a class="btn btn-primary" href="javascript:$(\'#collapse'.$defense["Matricule_etudiant"].'\').toggle();" role="button" >Résumé</a></p><div class="collapse" id="collapse'.$defense["Matricule_etudiant"].'"><div class="card card-body">'.$defense["these_resume_fr"]."</div></div>";
    } else {
